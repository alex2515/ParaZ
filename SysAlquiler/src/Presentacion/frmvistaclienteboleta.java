...
public class frmvistaclienteboleta extends javax.swing.JInternalFrame {

    public frmvistaclienteboleta() {
        initComponents();
        mostrar("");
    }
...
//        tablalistado.getColumnModel().getColumn(11).setPreferredWidth(0);
    ...
    private void tablalistadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMousePressed
        ...
        if (evt.getClickCount() == 2) {
            ...
            frmalquilerboleta.txtnomape.setText(tablalistado.getValueAt(fila, 3).toString());
            frmalquilerboleta.txtdni.setText(tablalistado.getValueAt(fila, 2).toString());
            frmalquilerboleta.txtidecliente.setText(tablalistado.getValueAt(fila, 0).toString());
            frmalquilerboleta.txtdire.setText(tablalistado.getValueAt(fila, 6).toString());
            this.dispose();
