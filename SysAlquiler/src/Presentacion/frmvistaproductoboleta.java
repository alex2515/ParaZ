...
public class frmvistaproductoboleta extends javax.swing.JInternalFrame {

    public frmvistaproductoboleta() {
        initComponents();
        mostrar("");
    }
...
//        tablalistado.getColumnModel().getColumn(11).setPreferredWidth(0);
    ...
    private void tablalistadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMouseClicked
        ...
        try {
            DefaultTableModel modelo = (DefaultTableModel) frmalquilerboleta.tablalistado.getModel();
